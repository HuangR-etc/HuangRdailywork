...
library(nlme)
library(rr2)
setwd("D:/pine/paper_redo/2025_09_obs_vs_pred/get_obs_pred/sauer")
#每次分析读取特定数据文件
filename <- "ogt_Sauer2019.csv"
#------通用数据读取和分析代码----------
...
#------新增：创建随机划分结果文件头----------
# 更新结果文件头
random_split_file <- "random_split_results_sauer.csv"
...
#-------1118版本结果分析--------
result <- read.csv("random_split_results_sauer.csv")
result1 <- result[1:50,]
